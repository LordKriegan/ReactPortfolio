    ...
    render() {
        return(
            <div className="text-center jumbotron">
                <h1>About Me</h1>
                <hr />
                <img className="profilePic img-responsive center-block" src={profilePic} alt="Profile Pic" />
                <div className="somePTags">
                    ...
                    <p>I am currently available for freelance projects! Feel free to <a href="/contact">contact me</a> if you would like me to work on something for you.</p>
                </div>
            </div>
        );
    }
